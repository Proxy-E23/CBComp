...
public class log2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Administrar cuenta");
        ...
        txt_user.setText("Ejemplo: Pablo");
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        ...
        setExtendedState(log2.CROSSHAIR_CURSOR);
      ...
      usuario = txt_user.getText();
        ...
        try {
            if (rs.next()) {
                ...
                if (main.nick.equalsIgnoreCase(usuario) && main.pass.equalsIgnoreCase(contraseña)) {
                    
                    main.nom = rs.getString("Nombre");
                    main.ap = rs.getString("Apellido");
                    main.pregunta = rs.getString("Pregunta");
                    main.respuesta = rs.getString("Respuesta");
                    ...
                    javax.swing.JOptionPane.showMessageDialog(null,
                            "¡El usuario con el que intento loguear no corresponde a la secion activa!.");
                }
